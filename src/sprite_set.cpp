...
sprite_set sprite_set::load(const m4c0::native_handles * np, const char * filename, bool has_tiles) {
...
void sprite_set::draw(int sx, int sy, int i, pixel_t color) const {
